  ...
  return (
    <section id="brand" className="space-y-10 pb-10 md:space-y-16 md:pb-20">
      <div className="space-y-5 md:space-y-10">
        ...
        <p className="text-sm">
          <strong>WorkRide</strong> is more than a name—it's a philosophy.
          WorkRide embodies our mission to transform the way we move, connect, and care for our
        ...
        <p className="text-sm italic text-teal-600">
          <strong className="font-extrabold">“WorkRide”</strong> ={' '}
        ...
        <p className="text-sm">
          The name <strong>WorkRide</strong> thus represents not just the act of
